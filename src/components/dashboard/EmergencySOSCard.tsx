...
export function EmergencySOSCard({ request, userRole, onRespond, onAcknowledge }: EmergencySOSCardProps) {
  ...
  return (
    <div className="p-4 flex justify-center">
      <Card className={`slide-in-medical ${request.priority === 'critical' ? 'ring-2 ring-critical shadow-emergency' : 'shadow-card'} max-w-xl w-full`}>
            ...
            <div className="flex gap-2 pt-2">
              <Dialog>
                <DialogTrigger asChild>
                  <EmergencyButton variant="emergency" size="sm" className="flex-1">
